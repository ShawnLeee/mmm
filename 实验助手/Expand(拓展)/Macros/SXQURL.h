...
////////////////////////////////////////////实验部分////////////////////////////////////
#define SetReagentURL @"http://hualang.wicp.net:8090/LabAssistant/map/setReagents"
//获取实验或说明书下所有的实验步骤
#define ExperimentStepURL @"http://hualang.wicp.net:8090/LabAssistant/lab/getAllProcessExceptComplete"
//附近的试剂交换
#define AdjacentReagentURL @"http://hualang.wicp.net:8090/LabAssistant/map/around"
//正在进行的实验
#define DoingExpURL @"http://hualang.wicp.net:8090/LabAssistant/lab/getDoing"
//已完成的实验
#define DoneExpURL @"http://hualang.wicp.net:8090/LabAssistant/lab/getComplete"
// 获取实验所需的试剂
...
#define UserInfoURL @"http://hualang.wicp.net:8090/LabAssistant/myInfo/basic"
#define EditUserInfoURL @"http://hualang.wicp.net:8090/LabAssistant/myInfo/edit"
/**
 *  bbs
 */
#define BBSModulesURL @"http://hualang.wicp.net:8090/LabAssistant/bbs/modules"
#define BBSThemesURL @"http://hualang.wicp.net:8090/LabAssistant/bbs/topics"
#define BBSCommentsURL @"http://hualang.wicp.net:8090/LabAssistant/bbs/reviews"
 ...
 *  同步实验说明书
 */
#define SyncInstructionURL @"http://hualang.wicp.net:8090/LabAssistant/sync/pushExpInstruction"
#endif
